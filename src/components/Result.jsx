import isfjImg from '../image/소심이.png';
import isfpImg from '../image/부럽이.png';
import istjImg from '../image/라일리 아빠.png';
import istpImg from '../image/따분이.png';
import infjImg from '../image/당황이.png';
import infpImg from '../image/슬픔이.png';
import intjImg from '../image/불안이.png';
import intpImg from '../image/조던.png';
import esfjImg from '../image/라일리 엄마.png';
import esfpImg from '../image/피에로 풍선.png';
import estjImg from '../image/버럭이.png';
import estpImg from '../image/까칠이.png';
import enfjImg from '../image/기쁨이.png';
import enfpImg from '../image/빙봉.png';
import entjImg from '../image/아빠 버럭이.png';
import entpImg from '../image/무지개 유니콘.png';
...
function Result({score, resetState}) {
    ...
    return(
        <div className="content" id="result">
            ...
            <p id="qu">나와 닮은 인사이드 아웃 캐릭터는?</p>
            <p id="mbti">{result.mbti}</p>
            <p id="explain" className="card card-body border-primary">{result.explain}</p>
            <div className="btn btn-primary" onClick={handleRestart}>다시하기</div>
            <div className="btn btn-primary mt-4 mb-3" onClick={handleCopyLink}>링크복사</div>
        </div>
    )
}
